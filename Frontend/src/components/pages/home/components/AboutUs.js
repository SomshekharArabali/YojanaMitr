        ...
        <section className="px-8 py-12 ">
            <div className="container mx-auto">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <Info size={48} className="text-primary-blue mx-auto mb-4" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        <div>
                            <Target className="text-primary-blue mx-auto mb-2" size={32} />
                        ...
                        <div>
                            <Users className="text-primary-blue mx-auto mb-2" size={32} />
                        ...
                        <div>
                            <Shield className="text-primary-blue mx-auto mb-2" size={32} />
                    ...
                    <button className="bg-primary-blue text-white px-6 py-2 rounded-full hover:bg-secondary-blue transition duration-300">
                        Learn More About Us
                    </button>
                </div>
            </div>
