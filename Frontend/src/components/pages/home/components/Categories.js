...
const getHoverStyle = (bgColor) => {
    const styles = {
        'blue-500': 'hover:bg-primary-blue',
        'red-500': 'hover:bg-primary-blue',
        'purple-500': 'hover:bg-primary-blue',
        'yellow-500': 'hover:bg-primary-blue',
        'green-500': 'hover:bg-primary-blue',
        'lime-500': 'hover:bg-primary-blue',
        'indigo-500': 'hover:bg-primary-blue',
        'orange-500': 'hover:bg-primary-blue',
        'yellow-400': 'hover:bg-primary-blue',
        'blue-400': 'hover:bg-primary-blue',
        'green-600': 'hover:bg-primary-blue',
    };
