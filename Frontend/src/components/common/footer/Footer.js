...
const Footer = () => {
    ...
    return (
        <footer className="flex flex-col font-raleway ">
            ...
            <div className="bg-secondary-blue w-full flex justify-center items-center flex-col">
                <p className="text-white mt-2 font-poppins font-medium text-xl">
                    &copy; 2025 YojanaMitr. All rights reserved.
                </p>
                <Link
                    to="https://www.linkedin.com/in/somshekhar-arabali"
                    className="flex items-center gap-2 mb-2">
                    <p className="font-mono font-bold text-xl py-1">
                        <span className="shiny-text text-accent-yellow">
                            Developed by Somshekhar Arabali
                        </span>
                        {/* white color icon */}
