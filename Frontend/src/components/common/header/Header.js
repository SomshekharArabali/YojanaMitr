...
const Header = () => {
    ...
    return (
        <header className="bg-primary-blue h-20 flex items-center justify-between px-4 md:px-8 w-full relative">
            <Link className="pt-1 flex items-center" to="/">
                <img src={lionlogo || "/placeholder.svg"} alt="logo" className="w-12 md:w-16 mr-2" />
                <h1 className="text-white text-2xl md:text-3xl font-bold">YojanaMitr</h1>
            </Link>
            ...
            {isOpen && (
                <div onClick={() => { setIsOpen(!isOpen); }} className="absolute top-20 left-0 right-0 bg-primary-blue md:hidden min-h-screen z-50 px-6">
