...
const translations = {
    ...
    sd: {
        ...
        welcome: "السلام عليڪم! مان توهان کي هن اسڪيم کي بهتر طريقي سان سمجھڻ ۾ مدد ڪري سگھان ٿو. توهان ڇا ڄਾڻڻ چاهيو ٿا؟",
                ...
                if (content.length) {
                    return (
                        <div key={index} className="mb-3">
                            <div className="font-semibold text-primary-blue">{title.trim()}:</div>
                            <div className="pl-3">
        ...
        <div className="fixed bottom-4 right-4 z-50">
            {!isOpen ? (
                <button
                    ...
                    className="bg-primary-blue text-white p-4 rounded-full shadow-lg hover:bg-secondary-blue transition-colors"
                >
                    ...
                    <div className="bg-primary-blue text-white p-4 rounded-t-lg flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                            <select
                                ...
                                className="bg-secondary-blue text-white p-1 rounded"
                            >
                            ...
                            <button
                                ...
                                className="hover:bg-secondary-blue p-1 rounded transition-colors"
                            >
                                <X size={20} />
                            </button>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-4 border-t">
                        <div className="flex gap-2">
                            <input
                                ...
                                className="flex-1 p-2 border rounded-lg focus:outline-none focus:border-primary-blue"
                            />
                            <button
                                type="submit"
                                disabled={!input.trim() || isLoading}
                                className="bg-primary-blue text-white p-2 rounded-lg hover:bg-secondary-blue disabled:opacity-50"
                            >
                                <Send size={20} />
                            </button>
                        </div>
